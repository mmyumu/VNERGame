...
import fr.mmyumu.vnergame.Animation;
...
public class OverworldScreen extends Screen {
	...
	private static OverworldCharacter mainCharacter;
	public static OverworldHeliboy hb, hb2;

	private Image currentSprite, character, character2, character3, heliboy,
			heliboy2, heliboy3, heliboy4, heliboy5;
	private Animation anim, hanim;

	private ArrayList<OverworldTile> tilearray = new ArrayList<OverworldTile>();
	...
	public OverworldScreen(Game game) {
		...
		mainCharacter = new OverworldCharacter();
		hb = new OverworldHeliboy(340, 360);
		hb2 = new OverworldHeliboy(700, 360);
		...
		for (int j = 0; j < 12; j++) {
			...
			for (int i = 0; i < width; i++) {
				...
				if (i < line.length()) {
					...
					OverworldTile t = new OverworldTile(i, j, Character.getNumericValue(ch));
					tilearray.add(t);
				}
	...
	private void updateRunning(List<TouchEvent> touchEvents, float deltaTime) {
		...
		ArrayList projectiles = mainCharacter.getProjectiles();
		for (int i = 0; i < projectiles.size(); i++) {
			OverworldProjectile p = (OverworldProjectile) projectiles.get(i);
			if (p.isVisible() == true) {
				p.update();
			} else {
	...
	private void updateTiles() {
		...
		for (int i = 0; i < tilearray.size(); i++) {
			OverworldTile t = (OverworldTile) tilearray.get(i);
			t.update();
		}
	...
	public static OverworldCharacter getMainCharacter() {
		// TODO Auto-generated method stub
