...
public class Triangle extends Shape {
    ...
    private void init() {
        ...
        int vertexShader = AndroidGLUtils.loadShader(GLES20.GL_VERTEX_SHADER,
                vertexShaderCode);
        int fragmentShader = AndroidGLUtils.loadShader(GLES20.GL_FRAGMENT_SHADER,
                fragmentShaderCode);
    ...
    protected float[] getColor() {
        return new float[]{1f, 0f, 0f, 0.5f};
    }
    ...
    public void draw(float[] mvpMatrix) {
        ...
        final int vertexStride = getCoordsPerVertex() * 4; // 4 bytes per vertex
        ...
        // Draw the triangle
        int vertexCount = getCoords().length / getCoordsPerVertex();
